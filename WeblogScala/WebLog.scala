...
val base_df = spark.read.text("/home/siddharth/TA18/weblog.csv")
base_df.printSchema()
...
/*
  ...
  val avg_daily_request_per_host_df = total_req_per_day_df.join(
  	daily_hosts_df,
  	...
  	.select(
  		...
  		.alias("avg_req_per_host_per_day")).cache()
